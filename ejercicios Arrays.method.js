...
function numFilter(cel,num){
  return cel.filter(function(celNumber){
    var first = celNumber.toString().substr(0,3);
    var last = celNumber.toString().substr(-3);
    return (first == num || last == num);
  });
}

console.log(numFilter([784123123, 355676784, 3423543554], 784)); // [784123123, 355676784]
